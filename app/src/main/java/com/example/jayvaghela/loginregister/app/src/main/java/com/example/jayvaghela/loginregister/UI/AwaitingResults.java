...
public class AwaitingResults extends AppCompatActivity {

    public AwaitingResults(AppCompatActivity aca)
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        an.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                //finish();
                Intent i = new Intent(AwaitingResults.this, UserSearch.class);
                startActivity(i);
            }
